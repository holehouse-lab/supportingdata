...
# rounds of mutagenesis to accumulate mutations while preserving interaction 
# characteristics.
#
# We note we are preparing a manuscript describing this protocol in detail (Flynn 
# et al. in prep); if you feel this type of analysis is useful for your work, 
# please reach out to us for our updated version of this code!
#
# ~alex (Nov 2025)
...
# nb - housetools is a holehouselab specific package; IF you want to run this code 
# yourself we recommend you contact us so we can provide you with a newer version 
# of this code!
...
def subsample(inseqs, size=40):
    """
    Function to randomly subsample a dictionary of 
...
# ..............................................................................
#
def do_all_subsampling_v2(real_seq_lib, null_seq_lib, sample_size, wt_sequence):
    """
    Function to subsample real and null sequence libraries and 
    calculate conservation scores for each subsample.
    ...
    sample_size : int
        Number of sequences to subsample from each library  

    wt_sequence : str
        The wild-type sequence to include in each subsample

    Returns
    ----------------
    tuple
        A tuple of two lists. The first list contains the
        conservation scores for the real sequences, and the
        second list contains the conservation scores for the
        null sequences.
    
    """

    # Initialize lists to store conservation scores
    null_vals = []
    real_vals = []
        
    # Subsample sequences from both libraries
    sub_real = subsample(real_seq_lib, sample_size)
    sub_null = subsample(null_seq_lib, sample_size)
    
    # Add the wild-type sequence to both subsamples
    sub_real['wt'] = wt_sequence
    sub_null['wt'] = wt_sequence
    
    # Calculate conservation scores for both subsamples
...
def run_mutagenesis(input_sequence,
                    ...
                    verbose=True):
    """
    Function to run mutagenesis on an input sequence to generate new sequences
    that maintain similar interaction profiles with a fixed partner sequence.
